...
export const translations = {
    es: {
        ...
        metrics: {
            ...
            jobs: "Trabajos realizados como Freelancer",
            languages: "Idiomas dominados",
        },
        whatIDo: {
            subtitle: "Qué puedo aportar",
            title: "Te dejo claridad mensual y un sistema simple para sostenerla.",
            description: "Trabajo con lo que ya usás. Ordeno la base, simplifico el flujo y dejo una lectura mensual confiable.",
            points: [
                "Base única y ordenada (sin duplicados ni versiones paralelas).",
                "Reglas simples para cargar datos sin errores.",
                "Cierre mensual claro (qué mirar y cuándo).",
                "Dashboard o resumen mensual (lo mínimo necesario).",
            ],
            footer: "Menos herramientas. Más criterio. Y todo documentado para que se sostenga.",
        },
        whoAmI: {
            subtitle: "Quién soy",
        ...
        contact: {
            ...
            copy: "Copiar mail",
            copied: "Copiado",
            footer: "Te responderé lo más pronto que me sea posible.",
        },
        social: {
            site: "Sitio",
        }
    ...
    en: {
        ...
        metrics: {
            ...
            jobs: "Jobs completed as Freelancer",
            languages: "Languages mastered",
        },
        whatIDo: {
            subtitle: "What I bring to the table",
            title: "I leave you with monthly clarity and a simple system to sustain it.",
            description: "I work with what you already use. I organize the database, simplify the flow, and leave a reliable monthly reading.",
            points: [
                "Unique and organized database (no duplicates or parallel versions).",
                "Simple rules to load data without errors.",
                "Clear monthly closing (what to look at and when).",
                "Dashboard or monthly summary (the minimum necessary).",
            ],
            footer: "Fewer tools. More criteria. And everything documented so it lasts.",
        },
        whoAmI: {
            subtitle: "Who am I",
        ...
        contact: {
            subtitle: "Contact",
            description: "If you feel you need to organize your situation, write to me directly.",
            copy: "Copy email",
            copied: "Copied",
            footer: "I will reply as soon as possible.",
        },
        social: {
            site: "Website",
        }
